# Generated by Django 4.1.5 on 2023-03-03 19:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ADDITIONAL_USER_TABLE',
            fields=[
                ('id', models.CharField(max_length=20, primary_key=True, serialize=False)),
                ('sales_channel', models.CharField(blank=True, max_length=8)),
                ('user_status', models.CharField(max_length=8)),
                ('user_payday', models.DateTimeField(blank=True, default=datetime.datetime.now, verbose_name='payments checked')),
                ('user_prev_payday', models.DateTimeField(blank=True, default=datetime.datetime.now, verbose_name='last payments checked')),
                ('customer_key', models.CharField(blank=True, max_length=128)),
                ('billing_key', models.CharField(blank=True, max_length=128)),
            ],
        ),
        migrations.CreateModel(
            name='LOGIN_TRY',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payments_user', models.CharField(max_length=64)),
                ('payments_date', models.DateTimeField(default=datetime.datetime.now, verbose_name='date published')),
                ('payments_amount', models.CharField(max_length=16)),
                ('payments_key', models.CharField(blank=True, max_length=128)),
            ],
        ),
        migrations.CreateModel(
